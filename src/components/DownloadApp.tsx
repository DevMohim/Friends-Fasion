   ...
   return (
     <div className="container mx-auto px-16 py-0 mt-10">
       <div className="grid lg:grid-cols-2 gap-5 ">
         <div className="flex justify-center flex-col items-start gap-2 space-y-4 text-center">
           <div className='mx-auto space-y-4'>
             <h1 className="max-w-100 text-3xl lg:text-5xl font-bold">
               DOWNLOAD APP & GET VOUCHER
             </h1>
             <p className="max-w-75 font-normal text-[#7C7C7C] mx-auto">
         ...
         <div className="flex justify-center items-center">
           <img src={MobileIcon} alt="" className="w-75 h-auto mx-auto" />
         </div>
       </div>
     </div>
   );
